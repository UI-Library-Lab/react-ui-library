...
export default function BrainElectricity(props: IIconsCommonProps) {
  return (
    <StyledIcon
      width='24'
      height='24'
    ...
    >
      ...
      />
      <path
        d='M4.26392 15.6046C2.9243 14.9582 2.00004 13.5871 2.00004 12C2.00004 10.7884 2.53877 9.70253 3.38978 8.96899'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
      ...
      />
      <path
        d='M20.6102 8.96899C21.4612 9.70253 22 10.7884 22 12C22 12.7031 21.8186 13.3638 21.5 13.938'
        stroke='currentColor'
        strokeWidth='1.5'
        strokeLinecap='round'
        strokeLinejoin='round'
